...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState(JSON.parse('{\
    ...
    "dependencyTreeRoots": [\
      {\
        "name": "cloud-kruser-backend",\
        "reference": "workspace:."\
      },\
      {\
        "name": "goodbye",\
        "reference": "workspace:packages/goodbye"\
      },\
      {\
        "name": "hello",\
      ...
      {\
        "name": "visitor-counter-create",\
        "reference": "workspace:packages/visitor-counter-create"\
      }\
    ],\
    "enableTopLevelFallback": true,\
    "ignorePatternData": "(^(?:\\\\.yarn\\\\/sdks(?:\\\\/(?!\\\\.{1,2}(?:\\\\/|$))(?:(?:(?!(?:^|\\\\/)\\\\.{1,2}(?:\\\\/|$)).)*?)|$))$)",\
    "fallbackExclusionList": [\
      ["cloud-kruser-backend", ["workspace:."]],\
      ["goodbye", ["workspace:packages/goodbye"]],\
      ["hello", ["workspace:packages/hello"]],\
      ["lambda", ["workspace:packages/lambda"]],\
      ["visitor-counter-create", ["workspace:packages/visitor-counter-create"]]\
    ],\
    "fallbackPool": [\
    ],\
    "packageRegistryData": [\
      ...
      ["@aws-sdk/types", [\
        ["npm:3.170.0", {\
          "packageLocation": "./.yarn/cache/@aws-sdk-types-npm-3.170.0-9e0ba238e2-c8c21c1bf5.zip/node_modules/@aws-sdk/types/",\
          "packageDependencies": [\
            ["@aws-sdk/types", "npm:3.170.0"]\
          ],\
          "linkType": "HARD"\
      ...
      ["goodbye", [\
        ["workspace:packages/goodbye", {\
          "packageLocation": "./packages/goodbye/",\
          "packageDependencies": [\
            ["goodbye", "workspace:packages/goodbye"]\
          ],\
          "linkType": "SOFT"\
      ...
      ["visitor-counter-create", [\
        ["workspace:packages/visitor-counter-create", {\
          "packageLocation": "./packages/visitor-counter-create/",\
          "packageDependencies": [\
            ["visitor-counter-create", "workspace:packages/visitor-counter-create"]\
          ],\
          "linkType": "SOFT"\
